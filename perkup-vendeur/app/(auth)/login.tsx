...
export default function LoginScreen() {
  ...
  const handleLogin = async () => {
    try {
      ...
      // ✅ Connexion avec hook centralisé
      await login({
      ...
      >
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>
            Accédez à votre espace professionnel PerkUP
          </Text>
        </View>
        ...
        <View style={styles.form}>
          ...
          >
            ...
            >
              {loading ? (
                ...
                <>
                  <Ionicons name="log-in-outline" size={20} color={AppColors.textInverse} style={{ marginRight: 8 }} />
          ...
          <View style={styles.signupContainer}>
            <Text style={styles.signupText}>Pas encore de compte vendeur ? </Text>
          ...
          <View style={styles.clientInfoContainer}>
            ...
            <Text style={styles.clientInfoText}>
              Vous êtes un client ? Téléchargez l'app PerkUP Client
            </Text>
          </View>
        </View>
      </ScrollView>
