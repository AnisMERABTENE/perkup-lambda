/**
 * 🎨 PALETTE DE COULEURS PERKUP VENDEUR
 * Basée sur la confiance, professionnalisme et croissance business
 * Couleurs principales : Violet professionnel + Orange business + Vert succès
 */
...
// Couleurs étendues pour l'app vendeur
export default {
  // 🟣 Couleurs primaires (confiance professionnelle)
  primary: '#6366F1',        // Violet moderne - confiance + innovation
  primaryLight: '#8B5CF6',   // Violet clair
  primaryDark: '#4F46E5',    // Violet foncé
  
  // 🟠 Couleurs secondaires (énergie business)
  secondary: '#F97316',      // Orange vif - croissance + énergie
  secondaryLight: '#FB923C', // Orange clair
  secondaryDark: '#EA580C',  // Orange foncé
  
  // 🟢 Couleurs d'accent (succès business)
  accent: '#10B981',         // Vert émeraude - croissance + succès
  ...
  // 🌈 Gradients modernes (business professionnel)
  ...
  gradientBusiness: ['#F97316', '#6366F1'],    // Orange vers violet
